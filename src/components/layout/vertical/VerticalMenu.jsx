...
const VerticalMenu = ({ scrollMenu }) => {
  ...
  return (
    ...
    >
      ...
      >
        <MenuSection label='Quick Buttons'>
          ...
          >
            <MenuItem href='/analytics' target=''>Analytics</MenuItem>
            <MenuItem href='/analytics' target=''>Stocks</MenuItem>
            <MenuItem href='/analytics' target=''>Analytics</MenuItem>
            <MenuItem href='/analytics' target=''>Analytics</MenuItem>
            <MenuItem href='/analytics' target=''>Analytics</MenuItem>
          </SubMenu> */}
        ...
        <MenuSection label='Apps & Pages'>
          ...
          <SubMenu
            ...
            icon={<i className='ri-home-smile-line' />}
          >
            <MenuItem href='/pageX' target=''>Analytics</MenuItem>
            <MenuItem href='/pageX' target=''>Stocks</MenuItem>
            <MenuItem href='/pageX' target=''>Analytics</MenuItem>
            <MenuItem href='/pageX' target=''>Analytics</MenuItem>
            <MenuItem href='/pageX' target=''>Analytics</MenuItem>
          </SubMenu>
